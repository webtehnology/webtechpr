...
/* begin: ../../desktop.blocks/office/office.js */
modules.define('office', ['i-bem-dom','jquery',  'BEMHTML' ], function(provide, bemDom,$, BEMHTML) {
    ...
    onSetMod: {
        'js': {
            ...
            //Видимая ширина слайдбара
                 slidesWidth = (this.slideWidth + 90) * step; 
            ...
            var _this = this;
                 ...
                 slidesWidthFull = (this.slideWidth +90) * counter;
...
/* end: ../../desktop.blocks/office/office.js */
